...
- `/start` — привітання та головне меню (➕ Add meal / 📊 Today / ⚙️ Set profile / 📋 Plan)
- `/set_profile` — налаштувати профіль (вік, зріст, вага, стать, активність, ціль); рахує BMR і TDEE
...
- `/plan` — рекомендована денна норма калорій під ціль (TDEE − 400 / TDEE / TDEE + 300) + AI-ідеї страв
